...
import '../services/api/perenual_service.dart';
  ...
  Future<AnalysisResult?> analyzeSelectedImages() async {
    ...
    try {
      ...
      final result = AnalysisResult(
        ...
        locationHint: locationHint,
        sourceImagePaths: _selectedImages.map((e) => e.path).toList(),
      );

      _latestResult = result;
      await FirebaseService.instance.logAnalysis(
